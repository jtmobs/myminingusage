...
from miningusage.serializers import WebpageSerializer

from miningusage.models import WebSite, WebPage, Domain, WebPageIdentifier, WebPageIdentifierWebPage, Sequence, \
    SequenceIdentifier
from miningusage.serializers import WebSiteSerializer, WebpageSerializer, \
    DomainSerializer, WebPageIdentifierSerializer, WebPageIdentifierListSerializer, SequenceSerializer, \
    WebPageListSerializer
from miningusage.tasks import create_identifiers
from miningusage.utils import split_by_character_in_position, get_subsequences_gte
...
# Define DB Name
dbname = client['miningusage']

# Define Collection
collection = dbname['collectionweb']
